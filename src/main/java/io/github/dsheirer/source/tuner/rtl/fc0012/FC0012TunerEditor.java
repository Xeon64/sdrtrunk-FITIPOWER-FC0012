 ...
 * FC0012 Tuner Editor
 */
public class FC0012TunerEditor extends TunerEditor<RTL2832Tuner, FC0012TunerConfiguration>
{
    private final static Logger mLog = LoggerFactory.getLogger(FC0012TunerEditor.class);
    private static final long serialVersionUID = 1L;
    private static final FC0012EmbeddedTuner.LNAGain DEFAULT_LNA_GAIN = FC0012EmbeddedTuner.LNAGain.G03;
    ...
    private JComboBox<FC0012EmbeddedTuner.LNAGain> mLNAGainCombo;
     ...
     */
    public FC0012TunerEditor(UserPreferences userPreferences, TunerManager tunerManager, DiscoveredTuner discoveredTuner)
    {
    ...
    /**
     * Access the FC0012 embedded tuner
     * @return tuner if there is a tuner, or null otherwise
     */
    private FC0012EmbeddedTuner getEmbeddedTuner()
    {
        if(hasTuner())
        {
            return (FC0012EmbeddedTuner) getTuner().getController().getEmbeddedTuner();
        }
    ...
    private JButton getTunerInfoButton()
    {
        if(mTunerInfoButton == null)
        {
            ...
            mTunerInfoButton.addActionListener(e -> JOptionPane.showMessageDialog(FC0012TunerEditor.this,
    ...
    private JComboBox getLNAGainCombo()
    {
        ...
        {
            mLNAGainCombo = new JComboBox<>(FC0012EmbeddedTuner.LNAGain.values());
            ...
            mLNAGainCombo.addActionListener(arg0 ->
            {
                if(!isLoading())
                {
                    try
                    {
                        FC0012EmbeddedTuner.LNAGain lnaGain = (FC0012EmbeddedTuner.LNAGain) mLNAGainCombo.getSelectedItem();
                    ...
                    {
                        JOptionPane.showMessageDialog(FC0012TunerEditor.this, getLogPrefix() +
        ...
        if(mSampleRateCombo == null)
        {
            ...
            mSampleRateCombo.addActionListener(e ->
            {
                if(!isLoading())
                {
                    ...
                    {
                        JOptionPane.showMessageDialog(FC0012TunerEditor.this,
            ...
            mAgcToggleButton.addActionListener(arg0 ->
            {
                if(!isLoading())
                {
                    try
                    {
                        ...
                        FC0012EmbeddedTuner.LNAGain lnaGain = (FC0012EmbeddedTuner.LNAGain)getLNAGainCombo().getSelectedItem();
    ...
    public void save()
    {
        ...
        {
            FC0012TunerConfiguration config = getConfiguration();
